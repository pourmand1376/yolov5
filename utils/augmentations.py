    ...
    def __init__(self, size=640):
        ...
        try:
            ...
            T = [
                ...
                A.ChannelDropout(always_apply=False, p=0.4, channel_drop_range=(1, 2), fill_value=126),
                ...
                A.RandomContrast(always_apply=False, p=0.4, limit=(-0.44, 0.61)),
                ...
                A.SafeRotate(always_apply=False, p=0.8, limit=(-360, 360), interpolation=0, border_mode=0, value=(0, 0, 0), mask_value=None),
                A.RandomRotate90(always_apply=False, p=1),
                A.MedianBlur(always_apply=False, p=0.3, blur_limit=(3, 7)),
                A.GaussianBlur(always_apply=False, p=0.4, blur_limit=(3, 7), sigma_limit=(0.0, 0)),
                A.PadIfNeeded(always_apply=True, p=1.0, min_height=size, min_width=size, pad_height_divisor=None, pad_width_divisor=None, border_mode=0, value=(0, 0, 0), mask_value=None),
                A.RandomCrop(always_apply=False, p=1.0, height=size, width=size),
            ]
